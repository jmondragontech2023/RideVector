/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a5ec5347adb907240313fd201525725)
...
interface __BaseEnv_Env {
	...
	SUPABASE_URL: "https://hsokwavqmqlkbtnftoqw.supabase.co" | "https://REPLACE_ME_STAGING_REF.supabase.co" | "https://REPLACE_ME_PRODUCTION_REF.supabase.co" | "http://127.0.0.1:54321";
...
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		SUPABASE_URL: "https://hsokwavqmqlkbtnftoqw.supabase.co";
		TOMTOM_API_KEY: string;
	}
	interface StagingEnv {
		ENVIRONMENT: "staging";
		SUPABASE_URL: "https://REPLACE_ME_STAGING_REF.supabase.co";
		TOMTOM_API_KEY: string;
	}
	interface ProductionEnv {
		ENVIRONMENT: "production";
		SUPABASE_URL: "https://REPLACE_ME_PRODUCTION_REF.supabase.co";
		TOMTOM_API_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_URL" | "TOMTOM_API_KEY" | "VALHALLA_BASE_URL" | "OPEN_METEO_BASE_URL" | "TOMTOM_BASE_URL">> {}
}
