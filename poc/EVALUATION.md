...
3. Set the ride mode. For a loop, enter target distance and flexibility and confirm the displayed accepted range. For start-and-end, those fields are hidden; select distinct Start and End instead.
...
| 6 | Golden Gate Park to Crissy Field (start/end) | n/a (endpoints define ride) | n/a | pending | pending | n/a | pending | pending |
| 7 | Zilker Park to Texas Capitol (start/end) | n/a (endpoints define ride) | n/a | pending | pending | n/a | pending | pending |
